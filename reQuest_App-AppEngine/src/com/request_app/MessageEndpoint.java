 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "request_app.com", ownerName = "request_app.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  //private static final String API_KEY = "AIzaSyCMRukD0ECNDT-MOtmMWjWUeRKeOs6QHIc";  //android key
	 private static final String API_KEY = "AIzaSyAAytOzGRlVRkvu2XqKxKWKlp5H7cf6hnU"; //browser key
	 //private static final String API_KEY = "AIzaSyBMW0fQtoSRoRIacZWvZ2mxdXTwrLm3A7o"; //server key
